...
<?php
    if((isset($_POST['submit']))){
      ...
      $fees = $_POST["fees"];
      $status = $_POST["status"];
      $sql="INSERT INTO couriers (courier_id, send_name, send_no, send_address, rec_name, rec_no, rec_address, srcbranch, dstbranch, cou_weight, height, length, width, cou_fee, status) VALUES ('".$courier."','".$sendername."', '".$senderphone."','".$senderaddress."','".$recievername."','".$recieverphone."','".$recieveraddress."','".$srcbranch."','".$dstbranch."','".$weight."','".$height."','".$length."','".$width."','".$fees."','".$status."')";
