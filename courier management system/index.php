...
<section class="banner" id="banner">
    <div class="row" >
        <div class="col-7">
        <h1 style="font-size:70px;color:#737373;padding-left:30px;">Ensure Intelligent and Fastest Delivery and Accelerate Business Growth</h1>
        </div>
    </div>
</section>
<div class="row" style="margin-top:px;">
    ...
    <h1 style="font-size:50px;color:#fff;padding-left:30px;font-weight:500;text-align:center;">ABOUT </h1>
        <h2 style="font-size:30px;margin-top:40px;color:#fff;text-align:center;">Easy couriers helps Courier, Express, and Parcel companies bring operational efficiency by ensuring on-time and accurate pick-ups and deliveries with complete visibility into operationsany time, anywhere.</h2>
    </div>
    <div class="row" style="margin-top:30px;background-image: linear-gradient(rgba(4,9,30,0.7),rgba(4,9,30,0.7)),url(images/courier2.jpg);background-size: cover;
        ...
        <h2 style="color:#fff;font-size:50px;">FOR MORE INFORMATION</h2>
        <h4 style="color:#fff;font-size:30px;margin-left:17%;">STAY IN TOUCH</h4>
    </div>
</div>
<div class="row">
<div class="col-6" style="height:500px;padding-left:200px;padding-top:80px;background:#d9d9d9;">
    ...
    <div class="info" style="padding-left:60px;padding-top:20px;">
        <h5>Email</h5>
        <p>easycouriers@gmail.com</p>
        <h5>Phone</h5>
        <p>9695342879</p>
        <h5>Address</h5>
        <p>Vishweshwaraya Building, 5th street, JP nagar, Bangalore-560073</p>
    </div>
</div>
