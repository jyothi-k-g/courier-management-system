...
<div class="staff">
<a href="staffnewcourier.php" class="btn" style="font-size: 1em;color: #fff;background: #737373;display: inline-block;
...
<table class="table" style="background:#fff;">
  ...
  $sql= "SELECT *from couriers";
    ...
    <tr>
      ...
      <td><button type="button" class="btn btn-secondary" ><a href="staffviewcou.php?id=<?php echo $row["id"]; ?>" style="color:#fff;">View</a> </button></td>
    </tr>
  </tbody>
  <?php
  $i++;
